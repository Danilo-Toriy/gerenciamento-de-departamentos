...
> Desenvolva uma API REST com Spring Boot para gerenciar departamentos. O objetivo
é praticar mapeamento JPA e operações CRUD em contexto organizacional.
...
- Crie uma entidade JPA chamada Departamento com os atributos especificados
- Configure o nome da entidade JPA como Departamento
- Configure o nome da tabela no banco como tb_departamento
